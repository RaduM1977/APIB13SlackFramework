...
public class SendMessageStepDefs {
    ...
    public void message_is_successfully_delivered() {
        ...
        timeStamp = parsedResponse.getString("ts");
        message = parsedResponse.getString("message.text");
        Assert.assertEquals(CommonUtils.readProp("message"),message);

        System.out.println("POST message: "+message+" /ts: "+timeStamp);
